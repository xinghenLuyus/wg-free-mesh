...
![控制台概览](https://bu.dusays.com/2026/05/28/6a17f20138a26.png)
...
![配置页](https://bu.dusays.com/2026/05/28/6a17f2089412b.png)

### 自动生成 WireGuard 配置

系统根据配置、端点和 Mesh 对生成每个节点自己的配置文本，并为超出系统生成能力的字段提供手动维护的页面。如果有客户端，同步态的配置将会自动同步下发。

![配置预览](https://bu.dusays.com/2026/05/28/6a17f20d53bf3.png)
...
![端点控制](https://bu.dusays.com/2026/05/28/6a17f211a33e7.png)
