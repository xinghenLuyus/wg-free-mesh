...
PUBLIC_ORIGIN="${WFM_PUBLIC_ORIGIN:-}"
PUBLIC_ORIGIN_HOST="${PUBLIC_ORIGIN#*://}"
PUBLIC_ORIGIN_HOST="${PUBLIC_ORIGIN_HOST%%/*}"
if [ "${PUBLIC_ORIGIN_HOST#\[}" != "${PUBLIC_ORIGIN_HOST}" ]; then
  MQTT_PUBLIC_HOST="${PUBLIC_ORIGIN_HOST#\[}"
  MQTT_PUBLIC_HOST="${MQTT_PUBLIC_HOST%%\]*}"
else
  MQTT_PUBLIC_HOST="${PUBLIC_ORIGIN_HOST%%:*}"
fi
if [ -z "${MQTT_PUBLIC_HOST}" ] || [ "${MQTT_PUBLIC_HOST}" = "*" ]; then
